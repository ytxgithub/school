       		...
       		<div class="col-md-12">
       				...
       				<div class="panel panel-warning">
       					...
       					<div class="panel-body">
       						<form action="${pageContext.request.contextPath}/sch/schStulist" class="form-horizontal">
												...
												<td>
													<div class="btn-group dropdown">
														...
														<ul class="dropdown-menu">
															<li><a href="${pageContext.request.contextPath}/student/stuinfo?id=${s.id}&cha=1">查看信息</a></li>
															<li><a href="${pageContext.request.contextPath}/student/delstu?id=${s.id}&del=1">删除学生</a></li>
       							...
       							<ul class="pagination pull-right">
       								...
       								<c:choose>
										...
										<c:otherwise>
											...
											<li>
												<a href="${pageContext.request.contextPath}/sch/schStulist?pageIndex=${param.pageIndex-1}${par}">
													<span>&laquo;</span>
												</a>
											</li>
										</c:otherwise>
      								...
      								<c:forEach begin="1" step="1" var="i" end="${pageCount }">
      									<li><a href="${pageContext.request.contextPath}/sch/schStulist?pageIndex=${i}${par}">${i}</a></li>
      								</c:forEach>
      								
      								<c:choose>
										<c:when test="${param.pageIndex<pageCount}">
											<li>
												<a href="${pageContext.request.contextPath}/sch/schStulist?pageIndex=${param.pageIndex+1}${par}" aria-label="Next">
													<span>&raquo;</span>
												</a>
											</li>
										</c:when>
