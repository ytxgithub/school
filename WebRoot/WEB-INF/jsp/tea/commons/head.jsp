          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile">
              <div class="profile_pic">
              	<c:choose>
					<c:when test="${sessionScope.TEACHER.photo==null }">
						<img src="${pageContext.request.contextPath}/uploads/wu/wu.jpg"  class="img-circle profile_img"/>
					</c:when>
					<c:otherwise>
						<img src="${pageContext.request.contextPath}/uploads/tea/${sessionScope.TEACHER.photo}"  class="img-circle profile_img"/>
					</c:otherwise>
				</c:choose>
              </div>
